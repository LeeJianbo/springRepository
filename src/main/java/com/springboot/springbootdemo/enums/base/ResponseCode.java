package com.springboot.springbootdemo.enums.base;
/**
...
public enum ResponseCode {
    CODE_200("200","操作成功！！"),CODE_401("401","未授权"),CODE_441("441","许可拒绝"),
    CODE_400("400","请求错误"),CODE_403("403","服务器拒绝请求"),CODE_405("405","方法禁用"),CODE_409("409","冲突"),
    CODE_444("444","性能超时"),
    CODE_500("500","服务器内部错误"),
    CODE_4431("4431","用户或密码错误"),
    CODE_4432("4432","账户已停用");
